...
1. 위의 **Android APK 다운로드** 링크에서 APK 파일을 내려받습니다.
2. Android가 설치를 차단하면 브라우저 또는 파일 앱의 **이 출처의 앱 설치 허용**을 활성화합니다.
3. APK를 설치하고 앱 이름 **이음**을 실행합니다.
4. 이메일 회원가입 또는 카카오 로그인을 진행합니다.
5. 신규 사용자는 온보딩을 완료한 뒤 서비스를 사용할 수 있습니다.
